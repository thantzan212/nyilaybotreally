...
from AsunaRobot import telethn as bot
from AsunaRobot.modules.urluploader import download_file
from AsunaRobot.utils.uputils import humanbytes, progress
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            await bot.send_file(
                ...
                dosya,
                force_document=True,
                caption=f"Uploaded By *N4 Group Manager*",
            )
        except Exception as e:
            traceback.print_exc()
